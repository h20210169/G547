...
9) cat > /dev/dof1 
After this command type " Hi this is mohit's first partition !" and then press ctrl+C. This will write this sentence on dof1

10)  cat > /dev/dof2 
After this command type " Hi this is mohit's partition" and then press ctrl+C. This will write this sentence on dof2
